-- Squashed demo seed data for booking-service.
-- Generated by combining prior db/dev-migration files in Flyway version order.

-- BEGIN V3__seed_demo_booking_data.sql
...
INSERT INTO bookings (id, booking_code, client_id, sub_field_id, owner_id, booking_date, start_time, end_time,
                      duration_minutes, price_per_hour, total_amount, sub_field_price, status, note, cancellation_reason,
...
-- END V3__seed_demo_booking_data.sql
