...
public interface BookingModerationService {
    ...
    PageResponse<BookingNoShowReportResponse> getNoShowReports(UUID actorId, String actorRole, UUID fieldId, Pageable pageable);
    PageResponse<ModerationAuditLogResponse> getAuditLogs(UUID actorId, String actorRole, UUID fieldId, Pageable pageable);
    PageResponse<ModerationAuditLogResponse> getUserAuditLogs(UUID userId, Pageable pageable);
    ...
    ModerationResetResponse resetPlatformBan(UUID actorId, UUID userId);
    ...
    PageResponse<PaymentDisputeReportResponse> getAdminDisputes(PaymentDisputeStatus status, Collection<UUID> fieldIds, Pageable pageable);
